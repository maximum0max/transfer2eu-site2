...
const STATIC_SEO = {
  home: {
    ...
    description: 'Частный трансфер из аэропорта Аликанте (ALC) в Бенидорм 60€, Кальпе 60€, Торревьеху 60€, Валенсию 150€ и 40+ городов Costa Blanca. Фиксированная цена, русскоязычный водитель, встреча с табличкой, работаем 24/7.',
  },
  routes: {
  ...
  price: {
    ...
    description: 'Актуальные цены на трансфер из аэропорта Аликанте: фиксированная стоимость за автомобиль. Бенидорм 60€, Кальпе 60€, Торревьеха 60€, Мурсия 75€, Валенсия 150€ и 40+ направлений.',
  },
  contacts: {
